...
add_action('do_feed_rdf', 'construeficaz_disable_feed', 1);
add_action('do_feed_rss', 'construeficaz_disable_feed', 1);
add_action('do_feed_rss2', 'construeficaz_disable_feed', 1);
add_action('do_feed_atom', 'construeficaz_disable_feed', 1);
...
add_action('wp_before_admin_bar_render', 'construeficaz_custom_logo');
