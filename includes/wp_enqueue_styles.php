...
function construeficaz_load_styles()
{
    $version_remove = NULL;
    if (!is_admin()) {
        ...
        /*- MAIN STYLE -*/
        wp_register_style('main-style', get_template_directory_uri() . '/css/construeficaz-style.css', false, $version_remove, 'all');
        wp_enqueue_style('main-style');

        /*- WOOCOMMERCE OVERRIDES -*/
        if (class_exists('WooCommerce')) {
            wp_register_style('main-woocommerce-style', get_template_directory_uri() . '/css/construeficaz-woocommerce.css', false, $version_remove, 'all');
            wp_enqueue_style('main-woocommerce-style');
        }

        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/construeficaz-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'construeficaz_load_styles', 1);
