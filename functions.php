...
if (!is_admin()) add_action('wp_enqueue_scripts', 'construeficaz_enqueue_jquery');
function construeficaz_enqueue_jquery()
{
...
add_action('after_setup_theme', 'construeficaz_register_navwalker');
function construeficaz_register_navwalker()
{
...
register_nav_menus(array(
    'header_menu' => __('Menu Header', 'construeficaz'),
    'footer_menu' => __('Menu Footer', 'construeficaz'),
));
...
add_action('widgets_init', 'construeficaz_widgets_init');

function construeficaz_widgets_init()
{
    register_sidebar(array(
        'name' => __('Sidebar Principal', 'construeficaz'),
        'id' => 'main_sidebar',
        'description' => __('Estos widgets seran vistos en las entradas y páginas del sitio', 'construeficaz'),
    ...
    register_sidebars(4, array(
        'name'          => __('Pie de Página %d', 'construeficaz'),
        'id'            => 'sidebar_footer',
        'description'   => __('Estos widgets seran vistos en el pie de página del sitio', 'construeficaz'),
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget'  => '</li>',
        'before_title'  => '<h2 class="widgettitle">',
        'after_title'   => '</h2>'
    ...
    if (class_exists('WooCommerce')) {
        register_sidebar(array(
            'name' => __('Sidebar de la Tienda', 'construeficaz'),
            'id' => 'shop_sidebar',
            'description' => __('Estos widgets seran vistos en Tienda y Categorias de Producto', 'construeficaz'),
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget'  => '</li>',
            'before_title'  => '<h2 class="widgettitle">',
            'after_title'   => '</h2>',
